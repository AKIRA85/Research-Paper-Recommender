...
while k<len_c:
    ...
    #Removing Blank Cititng Authors
        flag=0
                ...
                for j in range(0,len(cited_list)):
                    if g.has_edge(citing_list[i],cited_list[j]):
                        ...
                        if citing_list[i]=='' or cited_list[j]=='':
                            ...
                            #print(g.node[citing_list[i]]['trust'])
...
g.add_edge('2','1',citation=1,colla=3,total=2.2)
g.add_edge('2','3',citation=2,colla=0,total=0.8)
g.add_edge('3','6',citation=2,colla=0,total=0.8)
g.add_edge('1','3',citation=2,colla=2,total=2.0)
g.add_edge('2','6',citation=1,colla=0,total=0.4)
g.add_edge('4','5',citation=1,colla=1,total=1.0)
g.add_edge('5','4',citation=2,colla=1,total=1.4)
g.add_edge('1','4',citation=2,colla=0,total=0.8)
g.add_edge('1','2',citation=2,colla=3,total=2.6)
g.add_edge('5','3',citation=2,colla=0,total=0.8)
g.add_edge('5','2',citation=0,colla=2,total=1.2)
...
w=0
buff=''
of=open('Trust_temp_5.txt','w')
while w<w1:
    buff=buff+node_list[w]+'\t'+str(g.node[node_list[w]]['u_trust'])+'\n'
    w=w+1
of.write(buff)
of.close()
